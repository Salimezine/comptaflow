...
for (const emp of juneData.employees) {
  ...
  // The Excel "SALAIRE DE Brut" = base + complement = old total base
  // The bulletin splits into 1000 (base) + 1100 (complement)
  // We use the sum as our base
  const baseBrut = emp.salaire_brut; // Excel col T = base + complement
